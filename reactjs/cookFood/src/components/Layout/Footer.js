        ...
        <div className="footer-content-column">
          <div className="footer-logo">
            <a className="footer-logo-link" href="#">
              ...
              <h1>LOGO</h1> */}
              <img  src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcT_Jq3bk3mXllU58cgnNQfiOHeutpNym3CujQ&usqp=CAU"
              style={{"borderRadius": "114px" }}
              />
            </a>
          </div>
      ...
      <div className="footer-copyright">
        <div className="footer-copyright-wrapper">
          <p className="footer-copyright-text">
            <a className="footer-copyright-link" href="#" target="_self"> ©2020. | All rights reserved. </a>
          </p>
        </div>
      </div>
    </footer>
