...
function CardLayout({product}) {
  ...
  return (
   ...
   <div className='front'>
    ...
    <Link to={`/product/${product._id}`}><Card.Img variant="top" src={`https://stationary-backend-side.onrender.com/static/Uploads/${product.image}`} style={{ width: '18rem',height:'35vh' }} className='profile'/></Link>
    </div>
    <Card.Body>
